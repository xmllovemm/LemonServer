// =================================================================================
// ORACLE, ODBC and DB2/CLI Template Library, Version 4.0.281,
...
#define OTL_VERSION_NUMBER (0x040119L)
...
public:
	...
	otl_auto_array_ptr(const int arr_size):
		ptr(new T[arr_size]),arr_size_(arr_size)
	{
	}
...
private:
  ...
  otl_lob_stream_generic& operator=(otl_lob_stream_generic&&)
  {
    ...
    (__GNUC_MINOR__>=1) || defined(__GNUC__) && (__GNUC__>4)) || \
    defined(__SUNPRO_CC) ||                                        \
  ...
  // member functions at all, or have bugs: g++ older than 4.1, Forte C++ (Solaris),
